<div class="sideoptions hiding">
    ...
    <div id="theme-switcher-wrapper">
        <div class="scroll-switcher">
            <h5 class="header">Color Options & Layout</h5>
            <ul class="reset-ul">
                <li>
            ...
            <div class="theme-color-wrapper clearfix">
                ...
                <a class="tooltip-button set-sidebar-style bg-gradient-8" data-header-bg="bg-gradient-8 font-inverse" title="Gradient 8" href="javascript:void(0);">Gradient 8</a><br><br>
