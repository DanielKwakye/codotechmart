    ...
    <div class="app-content content container-fluid">
      <div class="content-wrapper">
        ...
        <div class="content-body"><section class="col-md-4 offset-md-4 col-xs-8 offset-xs-2 box-shadow-2 p-0">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/administration/password/reset') }}">
                ...
                {{-- form goes in here --}}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                           {{--  <label for="email" class="col-md-4 control-label">E-Mail Address</label> --}}
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" placeholder="E-Mail Address" class="form-control input-lg" name="email" value="{{ $email or old('email') }}" autofocus style="margin: 5px">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="password" placeholder="Enter Your Password" class="form-control input-lg" name="password" style="margin: 5px">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                           {{--  <label for="password-confirm" class="col-md-4 control-label">Confirm Password</label> --}}
                            <div class="col-md-12">
                                <input id="password-confirm" type="password" placeholder="Confirm Password" class="form-control input-lg" name="password_confirmation" style="margin: 5px">
